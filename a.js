  ...
  return (
    <NavigationContainer>
      <myStack.Navigator 
         ...
         <myStack.Screen name="myCourse" component={myCourse}/>
         <myStack.Screen name="english" component={Stack}/>
  ...
  return (
    <NavigationContainer>
      <myStack.Navigator 
         ...
         <myStack.Screen name="myCourse" component={myCourse}/>
         <myStack.Screen name="english" component={englishStack}/>
...
screenOptions={{
    headerShown: false,
         ...
         <dashboardStack.Screen name="profile" component={profile} options={{title:'profile'}}/>
</dashboardStack.Navigator>
);
}
